package com.xp.springboot.mop.util.trade;
...
import com.xp.springboot.mop.util.IdWorker;
import com.xp.springboot.mop.util.LocalHostUtil;

/**
 * 
 * ClassName:IdGenerator  
 * Function: 生产主键，生成策略为：时间戳 + 机器id + 自增id.  
 * Date:     2016年4月11日 下午4:36:29  
 * @author   peng.xu
 * @version  1.0
 * @since    JDK 1.8
 */
...
public class IdGenerator implements Serializable {
	...
	/**
	 * 
	 * generateReadable:生成带有时间戳的定长id，长度:30；可读性略强，但性能较之generate()方法差了约3倍  
	 *
	 * @author peng.xu
	 * @return
	 * @since JDK 1.6
	...
	public static void main(String[] args) {
		Stream.generate(IdGenerator :: generateNumberId).limit(100).forEach(System.out :: println);
	}
}
