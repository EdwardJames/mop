 ...
 * @Description: 图片处理或者验证码识别去糙处理
 * @author peng.xu
 * @date 2017年9月25日 下午3:14:52
 *
 */
...
//        }
        File picFile = new File("F:/developer/OCR/numberWithPoint.png");
        cleanImage(picFile,"F:/developer/OCR/result");
